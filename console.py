...
record_label_repository.save(record_label_9)


album_1 = Album("Rumours", "Fleetwood Mac", "Pop-rock", record_label_1, 30, 10, 18)
album_repository.save(album_1)
album_2 = Album("Hounds of Love", "Kate Bush", "Pop", record_label_2, 5, 13, 23)
album_repository.save(album_2)
album_3 = Album("Born to Run", "Bruce Springsteen", "Rock", record_label_3, 2, 11, 16)
album_repository.save(album_3)
album_4 = Album("Automatic for the People", "R.E.M", "Alternative rock", record_label_1, 8, 10, 17)
album_repository.save(album_4)
album_5 = Album("The Dark Side of the Moon", "Pink Floyd", "Progressive Rock", record_label_2, 13, 9, 15)
album_repository.save(album_5)
album_6 = Album("Station to Station", "David Bowie", "Glam Rock", record_label_4, 4, 11, 15)
album_repository.save(album_6)
album_7 = Album("A Night at the Opera", "Queen", "Progressive Rock", record_label_5, 7, 12, 16)
album_repository.save(album_7)
album_8 = Album("The Queen is Dead", "The Smiths", "Indie Rock", record_label_6, 8, 13, 18)
album_repository.save(album_8)
album_9 = Album("Nevermind", "Nirvana", "Grunge", record_label_7, 15, 10, 15)
album_repository.save(album_9)
album_10 = Album("London's Calling", "The Clash", "Punk", record_label_8, 3, 8, 15)
